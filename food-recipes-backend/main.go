...
func main() {
	...
	r.POST("/recipes/:id/favorite", middleware.Authenticated(), handlers.AddFavorite)
	r.DELETE("/recipes/:id/favorite", middleware.Authenticated(), handlers.RemoveFavorite)
	r.POST("/recipes/:id/rate", middleware.Authenticated(), handlers.RateRecipe)
